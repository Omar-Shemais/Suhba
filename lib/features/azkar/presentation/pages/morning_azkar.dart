...
class MorningAzkar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (_) => AzkarCubit()..getMorningAzkar(),
      child: Scaffold(
        ...
        body: Container(
          ...
          child: BlocBuilder<AzkarCubit, AzkarState>(
            builder: (context, state) {
              ...
              } else if (state is MorningAzkarSuccess) {
            ...
            builder: (context, state) {
              if (state is AzkarLoading) {
                ...
                return Center(
                  child: Text(
                    "${"error_occurred".tr()}: ${state.message}",
                    style: const TextStyle(fontSize: 18.sp, color: Colors.red),
                  ),
                );
              } else if (state is MorningAzkarSuccess) {
                final azkarModel = state.azkarModel;
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        ...
                        shadowColor: Colors.orangeAccent.withValues(alpha: .3),
                        child: Padding(
                          padding: const EdgeInsets.all(16.0),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.end,
                            children: [
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.end,
                                children: [
                                  Icon(Icons.repeat, color: Colors.blueGrey, size: 20),
