...
class AfterPrayerAzkarScreen extends StatelessWidget {
  const AfterPrayerAzkarScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (_) => AzkarCubit()..getAfterPrayerAzkar(),
      child: Scaffold(
        extendBodyBehindAppBar: true,
        backgroundColor: theme.scaffoldBackgroundColor,
        appBar: AppBar(
          title: Text(
            'after_prayer_azkar'.tr(),
            style:
        ...
        body: Container(
          ...
          child: BlocBuilder<AzkarCubit, AzkarState>(
            builder: (context, state) {
              ...
              } else if (state is AfterPrayerAzkarSuccess) {
...
class AfterPrayerAzkarScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('after_prayer_azkar'.tr()),
          centerTitle: true,
        ),
